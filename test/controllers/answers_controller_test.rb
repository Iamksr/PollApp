...
class AnswersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create answer" do
    assert_difference('Answer.count') do
      post answers_url, params: { answer: { Title: @answer.Title, poll_id: @answer.poll_id } }
    end
  ...
  test "should update answer" do
    patch answer_url(@answer), params: { answer: { Title: @answer.Title, poll_id: @answer.poll_id } }
